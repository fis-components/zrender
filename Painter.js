...
Painter.prototype = {
    ...
    _paintList: function (list, paintAll) {
        ...
        for (var i = 0, l = list.length; i < l; i++) {
            ...
            if ((currentLayer.__dirty || paintAll) && !el.invisible && el.style.opacity !== 0    // Ignore scale 0 element, in some environment like node-canvas
                     // Draw a scale 0 element can cause all following draw wrong
&& el.scale[0] && el.scale[1]    // Ignore culled element
...
module.exports = Painter || module.exports;;